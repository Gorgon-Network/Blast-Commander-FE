          ...
          <div>
            ...
            <ul>
              <li>Elevate the gameplay experience with the introduction of boss battle modes and immersive exploration
                mechanics.</li>
              <li>Allow players to delve deeper into the Blast Commander universe, uncovering challenges and rewards along
                the way.</li>
            </ul>
          </div>
        </v-timeline-item>
        ...
        <v-timeline-item>
          ...
          <div>
            ...
            <ul>
              ...
              <li>Ensure player engagement and the longevity of Blast Commander by nurturing a vibrant and active player
                base.</li>
            </ul>
          </div>
        </v-timeline-item>
